...
export default class Game {
  constructor() {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      const pomaranczowyKwadrat = new THREE.Mesh(
        geometryPomaranczowegoKwadratu,
        materialPomaranczowy
      );
              ...
              for (let j = 5; j >= 0; j--) {
                if (this.pionki[j][data.kolumnaBiala] == 0) {
                  ...
                  new TWEEN.Tween(krazek.position) // co
                    .to(
                      { x: data.kolumnaBiala * 10 - 30, y: wysokosc, z: 0 },
                      500
            ...
            if (data.kolumnaCzarna != 2137) {
              for (let j = 5; j >= 0; j--) {
                if (this.pionki[j][data.kolumnaCzarna] == 0) {
                  ...
                  new TWEEN.Tween(krazek.position) // co
                    .to(
                      { x: data.kolumnaCzarna * 10 - 30, y: wysokosc, z: 0 },
                      500
                    ) // do jakiej pozycji, w jakim czasie
                    .easing(TWEEN.Easing.Cubic.Out) // typ easingu (zmiana w czasie)
                    .start();
      ...
      try {
        for (let i = 0; i < 6; i++) {
          for (let j = 0; j < 7; j++) {
            if (
              this.pionki[i][j] == 1 &&
              this.pionki[i + 1][j + 1] == 1 &&
              this.pionki[i + 2][j + 2] == 1 &&
              this.pionki[i + 3][j + 3] == 1
            ) {
            ...
            if (
              this.pionki[i][j] == 2 &&
              this.pionki[i + 1][j + 1] == 2 &&
              this.pionki[i + 2][j + 2] == 2 &&
              this.pionki[i + 3][j + 3] == 2
            ) {
      ...
      try {
        for (let i = 0; i < 6; i++) {
          for (let j = 0; j < 7; j++) {
            if (
              this.pionki[i + 3][j] == 1 &&
              this.pionki[i + 2][j + 1] == 1 &&
              this.pionki[i + 1][j + 2] == 1 &&
              this.pionki[i][j + 3] == 1
            ) {
            ...
            if (
              this.pionki[i + 3][j] == 2 &&
              this.pionki[i + 2][j + 1] == 2 &&
              this.pionki[i + 1][j + 2] == 2 &&
              this.pionki[i][j + 3] == 2
            ) {
    ...
    window.addEventListener("mousedown", (e) => {
      ...
      if (
        ...
        if (
          intersects.length > 0 &&
          intersects[0].object.material.color.getHex() == 0xff8c00
        ) {
